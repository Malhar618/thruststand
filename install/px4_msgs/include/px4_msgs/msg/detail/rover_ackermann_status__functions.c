...
{
  px4_msgs__msg__RoverAckermannStatus * msg = (px4_msgs__msg__RoverAckermannStatus *)malloc(sizeof(px4_msgs__msg__RoverAckermannStatus));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__RoverAckermannStatus__Sequence__init(px4_msgs__msg__RoverAckermannStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__RoverAckermannStatus *)calloc(size, sizeof(px4_msgs__msg__RoverAckermannStatus));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__RoverAckermannStatus__Sequence * array = (px4_msgs__msg__RoverAckermannStatus__Sequence *)malloc(sizeof(px4_msgs__msg__RoverAckermannStatus__Sequence));
  if (!array) {
    return NULL;
  }
