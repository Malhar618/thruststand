  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: heading_var
  {
    ...
    out << "heading_var: ";
    value_to_yaml(msg.heading_var, out);
    out << "\n";
  }
  ...
  // member: unaided_heading
  {
    ...
    out << "unaided_heading: ";
    value_to_yaml(msg.unaided_heading, out);
    out << "\n";
  }
  ...
  // member: tilt_var
  {
    ...
    out << "tilt_var: ";
    value_to_yaml(msg.tilt_var, out);
    out << "\n";
  }
  ...
  // member: dist_bottom_var
  {
    ...
    out << "dist_bottom_var: ";
    value_to_yaml(msg.dist_bottom_var, out);
    out << "\n";
  }
  ...
  // member: delta_dist_bottom
  {
    ...
    value_to_yaml(msg.delta_dist_bottom, out);
    out << "\n";
  }
  ...
  // member: dist_bottom_reset_counter
  {
    ...
    value_to_yaml(msg.dist_bottom_reset_counter, out);
    out << "\n";
  }
