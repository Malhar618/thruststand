...
{
  px4_msgs__msg__RoverDifferentialSetpoint * msg = (px4_msgs__msg__RoverDifferentialSetpoint *)malloc(sizeof(px4_msgs__msg__RoverDifferentialSetpoint));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__RoverDifferentialSetpoint__Sequence__init(px4_msgs__msg__RoverDifferentialSetpoint__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__RoverDifferentialSetpoint *)calloc(size, sizeof(px4_msgs__msg__RoverDifferentialSetpoint));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__RoverDifferentialSetpoint__Sequence * array = (px4_msgs__msg__RoverDifferentialSetpoint__Sequence *)malloc(sizeof(px4_msgs__msg__RoverDifferentialSetpoint__Sequence));
  if (!array) {
    return NULL;
  }
