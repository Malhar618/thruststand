...
{
  px4_msgs__msg__RoverAckermannSetpoint * msg = (px4_msgs__msg__RoverAckermannSetpoint *)malloc(sizeof(px4_msgs__msg__RoverAckermannSetpoint));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__RoverAckermannSetpoint__Sequence__init(px4_msgs__msg__RoverAckermannSetpoint__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__RoverAckermannSetpoint *)calloc(size, sizeof(px4_msgs__msg__RoverAckermannSetpoint));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__RoverAckermannSetpoint__Sequence * array = (px4_msgs__msg__RoverAckermannSetpoint__Sequence *)malloc(sizeof(px4_msgs__msg__RoverAckermannSetpoint__Sequence));
  if (!array) {
    return NULL;
  }
