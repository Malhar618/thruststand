  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: cs_gnss_yaw
  {
    ...
    out << "cs_gnss_yaw: ";
    value_to_yaml(msg.cs_gnss_yaw, out);
    out << "\n";
  }
  ...
  // member: cs_gnss_yaw_fault
  {
    ...
    value_to_yaml(msg.cs_gnss_yaw_fault, out);
    out << "\n";
  }
  ...
  // member: cs_ev_yaw_fault
  {
    ...
    out << "cs_ev_yaw_fault: ";
    value_to_yaml(msg.cs_ev_yaw_fault, out);
    out << "\n";
  }
  ...
  // member: cs_mag_heading_consistent
  {
    ...
    value_to_yaml(msg.cs_mag_heading_consistent, out);
    out << "\n";
  }
  ...
  // member: cs_aux_gpos
  {
    ...
    out << "cs_aux_gpos: ";
    value_to_yaml(msg.cs_aux_gpos, out);
    out << "\n";
  }
  ...
  // member: cs_rng_terrain
  {
    ...
    out << "cs_rng_terrain: ";
    value_to_yaml(msg.cs_rng_terrain, out);
    out << "\n";
  }
  ...
  // member: cs_opt_flow_terrain
  {
    ...
    value_to_yaml(msg.cs_opt_flow_terrain, out);
    out << "\n";
  }
  ...
  // member: cs_valid_fake_pos
  {
    ...
    value_to_yaml(msg.cs_valid_fake_pos, out);
    out << "\n";
  }
  ...
  // member: cs_constant_pos
  {
    ...
    out << "cs_constant_pos: ";
    value_to_yaml(msg.cs_constant_pos, out);
    out << "\n";
  }
