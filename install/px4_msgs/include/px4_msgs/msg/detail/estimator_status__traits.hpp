  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: hdg_test_ratio
  {
    ...
    out << "hdg_test_ratio: ";
    value_to_yaml(msg.hdg_test_ratio, out);
    out << "\n";
  }
  ...
  // member: pre_flt_fail_innov_pos_horiz
  {
    ...
    value_to_yaml(msg.pre_flt_fail_innov_pos_horiz, out);
    out << "\n";
  }
  ...
  // member: mag_inclination_deg
  {
    ...
    value_to_yaml(msg.mag_inclination_deg, out);
    out << "\n";
  }
  ...
  // member: mag_inclination_ref_deg
  {
    ...
    value_to_yaml(msg.mag_inclination_ref_deg, out);
    out << "\n";
  }
  ...
  // member: mag_strength_gs
  {
    ...
    out << "mag_strength_gs: ";
    value_to_yaml(msg.mag_strength_gs, out);
    out << "\n";
  }
  ...
  // member: mag_strength_ref_gs
  {
    ...
    value_to_yaml(msg.mag_strength_ref_gs, out);
    out << "\n";
  }
