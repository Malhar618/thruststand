  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: executor_in_charge
  {
    ...
    value_to_yaml(msg.executor_in_charge, out);
    out << "\n";
  }
  ...
  // member: valid_nav_states_mask
  {
    ...
    value_to_yaml(msg.valid_nav_states_mask, out);
    out << "\n";
  }
  ...
  // member: can_set_nav_states_mask
  {
    ...
    value_to_yaml(msg.can_set_nav_states_mask, out);
    out << "\n";
  }
  ...
  // member: failsafe_defer_state
  {
    ...
    value_to_yaml(msg.failsafe_defer_state, out);
    out << "\n";
  }
