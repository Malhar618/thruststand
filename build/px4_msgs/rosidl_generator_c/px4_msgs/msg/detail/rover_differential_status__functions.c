...
{
  px4_msgs__msg__RoverDifferentialStatus * msg = (px4_msgs__msg__RoverDifferentialStatus *)malloc(sizeof(px4_msgs__msg__RoverDifferentialStatus));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__RoverDifferentialStatus__Sequence__init(px4_msgs__msg__RoverDifferentialStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__RoverDifferentialStatus *)calloc(size, sizeof(px4_msgs__msg__RoverDifferentialStatus));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__RoverDifferentialStatus__Sequence * array = (px4_msgs__msg__RoverDifferentialStatus__Sequence *)malloc(sizeof(px4_msgs__msg__RoverDifferentialStatus__Sequence));
  if (!array) {
    return NULL;
  }
