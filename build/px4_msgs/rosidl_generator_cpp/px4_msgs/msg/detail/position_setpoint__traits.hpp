  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: loiter_minor_radius
  {
    ...
    value_to_yaml(msg.loiter_minor_radius, out);
    out << "\n";
  }
  ...
  // member: loiter_orientation
  {
    ...
    value_to_yaml(msg.loiter_orientation, out);
    out << "\n";
  }
  ...
  // member: loiter_pattern
  {
    ...
    out << "loiter_pattern: ";
    value_to_yaml(msg.loiter_pattern, out);
    out << "\n";
  }
  ...
  // member: alt_acceptance_radius
  {
    ...
    value_to_yaml(msg.alt_acceptance_radius, out);
    out << "\n";
  }
