  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: internal_resistance_estimate
  {
    ...
    value_to_yaml(msg.internal_resistance_estimate, out);
    out << "\n";
  }
  ...
  // member: ocv_estimate
  {
    ...
    out << "ocv_estimate: ";
    value_to_yaml(msg.ocv_estimate, out);
    out << "\n";
  }
  ...
  // member: ocv_estimate_filtered
  {
    ...
    value_to_yaml(msg.ocv_estimate_filtered, out);
    out << "\n";
  }
  ...
  // member: volt_based_soc_estimate
  {
    ...
    value_to_yaml(msg.volt_based_soc_estimate, out);
    out << "\n";
  }
  ...
  // member: voltage_prediction
  {
    ...
    value_to_yaml(msg.voltage_prediction, out);
    out << "\n";
  }
  ...
  // member: prediction_error
  {
    ...
    value_to_yaml(msg.prediction_error, out);
    out << "\n";
  }
  ...
  // member: estimation_covariance_norm
  {
    ...
    value_to_yaml(msg.estimation_covariance_norm, out);
    out << "\n";
  }
